...
export const updateService = (id, title, text, banner) => News.findOneAndUpdate({ _id: id }, { title, text, banner }, { includeResultMetadata: false, });

/*
A opção `rawResult` para consultas Mongoose está obsoleta. Use `includeResultMetadata: false` como um substituto para `rawResult: true`
*/
